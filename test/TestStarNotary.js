...
it('can add the star name and star symbol properly', async() => {
    ...
    let tokenId = 213;
    let instance = await StarNotary.deployed();
    await instance.createStar('Moon', tokenId, {from: user1})
    assert.equal(await instance.name(), 'Star Crypto Token')
    assert.equal(await instance.symbol(), 'SCT')
});
...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('Moon', tokenId1, {from: user1})
    await instance.createStar('Mars', tokenId2, {from: user2})
